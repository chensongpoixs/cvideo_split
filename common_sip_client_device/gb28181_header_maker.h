...
namespace chen {
	...
	static const uint32_t  PS_HDR_LEN = 14;
	static const uint32_t  SYS_HDR_LEN =18;
	static const uint32_t PSM_HDR_LEN =24;
	static const uint32_t PES_HDR_LEN =19;
	static const uint32_t RTP_HDR_LEN = 12;

	static const uint32_t  RTP_PKT_END = 1;
	static const uint32_t  RTP_PKT_APPENDING = 0;
