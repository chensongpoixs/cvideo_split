...
#define PARSE_NAME_VALUE(VAR, NAME, TYPE) 							\
	...
	bool cweb_http_api_mgr::init()
	{
		...
		REGISTER_WEB_HANDLER("modify_camera_info", "POST", std::bind(&cweb_http_api_mgr::_handler_modify_camera_infos, this, std::placeholders::_1, std::placeholders::_2));
	...
	cresult_add_camera_info cweb_http_api_mgr::modify_camera_infos(const AddCameraInfos& msg)
	{
		return g_camera_info_mgr.handler_modify_camera_infos(msg);
	}
